# 🎨 Sun AI — Master UI/UX Design Prompts (v2 - Production Ready)

**Purpose:** This document provides the **final, production-ready** prompt library for generating the Sun AI interface. It incorporates advanced logic for system states, conversion anchors, and internal tooling.

**Aesthetic Goal:** "Premium, Intelligent, Luxury Tech."
**Key Visuals:** Slate 900 (Hero/Bento), Warm White (Content), Orange-500 Accents, Glassmorphism, Scroll-Storytelling.
...
> 7.  **Internal CRM** (`/dashboard/leads`): Simple admin view (Future proofing).
>
> **Routing Rules:**
...
> -   **Wizard Mode:** Minimized navigation (Logo + Exit only) inside the Wizard.
>
> **Deliverables:**
...
>
> **Visual:**
> -   **Illustration:** A 3D/Abstract representation of a 'Digital Brain' or 'Neural Network'.
...
> -   Abstract visualizations for each service."
...
>     *   *Microcopy:* 'We analyze your site to tailor recommendations. No data is stored.'
...
> -   **Decision Anchor:** Add a 'Recommended' badge or 'Most popular choice' text to the primary option.
...
**Goal:** Assist users without blocking content.
...
> -   **Logic:** Appears after 10s delay OR on hesitation. Suppressed on Checkout.
>
> **Open State:**
...
> **Prompt:**
> "Apply a comprehensive **Motion System**.
>
> **Rules:**
> -   **Hover:** Elements lift (translate-y -4px) and shadow deepens.
> -   **Scroll:** Sections fade in and slide up (20px). Stagger children.
> -   **Transitions:** Smooth page transitions.
> -   **Feedback:** Buttons scale down slightly (0.98) on click.
>
> **Accessibility:**
> -   **Reduced Motion:** Disable transforms, use Opacity only."

---

### STEP 12 — System States (Global)
**Goal:** Handle edge cases gracefully.

> **Prompt:**
> "Design **Global System States** for the application.
>
> **States to Cover:**
> 1.  **Empty State:** (e.g., Dashboard with no projects). 'No active projects yet. Start a brief to begin.'
> 2.  **Error State:** (e.g., Payment failed). 'Transaction declined. Please check your card.' (Gentle, red accent).
> 3.  **Success State:** (e.g., Booking confirmed). Confetti animation + 'You are all set!'.
> 4.  **Loading State:** Skeleton screens for dashboard widgets.
>
> **Visuals:** Use consistent illustrations and typography."

---

### STEP 13 — Internal Tools (Optional)
**Goal:** Basic admin visibility.

> **Prompt:**
> "Design a basic **Internal Lead Dashboard** (`/dashboard/leads`).
>
> **Layout:** Simple data table.
> **Columns:** Name, Company, Status (New, Proposal Sent, Booked), Date.
> **Actions:** 'View Proposal', 'Mark as Contacted'.
> **Visual:** Clean, high-density, utility-focused."
