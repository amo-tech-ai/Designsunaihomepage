...
const mockAISuggestions: AISuggestion[] = [
  {
    ...
    rationale: 'Passwordless login improves security and reduces friction for users. Industry trend shows 40% higher conversion rates.',
    category: 'backend',
  },
  {
    id: 's2',
    title: 'AI Sentiment Analysis',
    rationale: 'Automatically detect frustrated customers and prioritize their tickets for human agent review. Improves customer satisfaction scores.',
    category: 'ai',
  },
  {
    id: 's3',
    title: 'Multi-language Support',
    rationale: 'Auto-detect customer language and provide responses in their preferred language. Expands market reach globally.',
    category: 'ai',
  },
  {
    id: 's4',
    title: 'Slack Notifications',
    rationale: 'Send real-time alerts to Slack when high-priority tickets arrive or SLA deadlines approach.',
    category: 'integration',
  },
  {
    id: 's5',
    title: 'Knowledge Base Widget',
    rationale: 'Embed a searchable knowledge base widget on your website to reduce ticket volume by 30-40%.',
    category: 'ui-ux',
  },
];
...
export function RequirementsPage() {
  ...
  return (
    <div className="flex h-full">
      {/* Main Content Area */}
      <div className={`flex-1 overflow-y-auto ${showAISuggestions ? 'pr-6' : ''}`}>
        {/* Header */}
        <div className="mb-8">
          <div className="flex items-start justify-between mb-6">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white border border-[#E9EAEE] text-[#555] hover:bg-[#F7F9FB] transition-all text-[14px]"
              >
        ...
        {emptyState ? (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-[14px] text-[#555] mb-6 max-w-md">
              Add your first requirement or let Sun AI suggest recommended features for your project.
            </p>
            <button
              onClick={handleAddRequirement}
      ...
      <AnimatePresence>
        {showAISuggestions && (
          <motion.div
            ...
            className="w-[380px] flex-shrink-0 ml-6 h-full overflow-y-auto"
          >
            <div className="bg-gradient-to-br from-[#F7F9FB] to-white rounded-2xl border border-[#E9EAEE] p-6 sticky top-0">
              ...
              <p className="text-[13px] text-[#555] mb-5">
                AI-generated feature recommendations based on your project type and goals.
              </p>
              ...
              <div className="space-y-3">
                {mockAISuggestions.map((suggestion, index) => (
                  <motion.div
                    ...
                    className="bg-white rounded-xl p-4 border border-[#E9EAEE] hover:border-[#FF6A3D] hover:shadow-sm transition-all"
                  >
                    <h4 className="text-[14px] text-[#202020] mb-2" style={{ fontWeight: 600 }}>
                      {suggestion.title}
                    </h4>
                    <p className="text-[12px] text-[#555] mb-3 leading-[1.6]">
                      {suggestion.rationale}
                    </p>
                    <button
                      onClick={() => handleAddSuggestion(suggestion)}
                      className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-gradient-to-r from-[#FF6A3D] to-[#FF8A4F] text-white hover:shadow-md transition-all text-[12px]"
