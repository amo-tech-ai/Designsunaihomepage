      ...
      >
        <div className="max-w-[1440px] mx-auto px-6 md:px-16 h-full flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link to="/services" className="text-[14px] font-medium text-[#1A3A32] transition-colors">
              Services
            </Link>
          ...
          <Link
            to="/wizard"
            className="px-6 py-3 bg-[#1A3A32] text-[#FAF8F5] text-[14px] font-medium rounded-lg hover:bg-[#152E28] transition-all duration-200 hover:shadow-lg"
          >
