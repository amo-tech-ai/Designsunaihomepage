  ...
  return (
    <div className="w-full h-full p-6 md:p-8 flex flex-col relative">
      <div className="text-center mb-6">
        <h3 className="text-xl font-bold text-[#00334F]">Project Scope Wizard</h3>
      ...
      <div className="mt-auto flex justify-center">
        <button className={`px-8 py-2 rounded-lg font-bold text-sm transition-all duration-300 ${
           isActive && selected ? "bg-[#00334F] text-white" : "bg-slate-100 text-slate-400"
        }`}>
          Continue
        </button>
      </div>
  ...
  return (
    <div className="w-full h-full p-6 md:p-8 flex flex-col relative">
      <div className="text-center mb-8">
        <h3 className="text-xl font-bold text-[#00334F]">Set Your Budget & Timeline</h3>
      </div>
      ...
      <div className="mt-auto flex justify-center">
         <button className={`px-8 py-2 rounded-lg font-bold text-sm transition-all duration-300 ${
           isActive && budget ? "bg-[#00334F] text-white" : "bg-slate-100 text-slate-400"
         }`}>
           Finish
         </button>
      </div>
  ...
  return (
    <div className="w-full h-full p-6 md:p-8 flex flex-col relative">
      <div className="flex justify-between items-start mb-6">
        <div>
           <h3 className="text-xl font-bold text-[#00334F]">Project Blueprint</h3>
      ...
      <div className="mt-auto flex justify-end">
        <button className="w-10 h-10 rounded-full bg-[#00334F] text-white flex items-center justify-center hover:bg-[#FF6A3D] transition-colors">
  ...
  return (
    <div className="w-full h-full flex relative bg-slate-50">
      ...
      <div className="w-16 bg-white border-r border-slate-100 flex flex-col items-center py-6 gap-6 z-10">
        <div className="p-2 bg-[#00334F] text-white rounded-lg shadow-lg shadow-[#00334F]/20"><Home className="w-4 h-4" /></div>
      ...
      <div className="flex-1 p-6 md:p-8">
         <div className="flex justify-between items-center mb-6">
           <h3 className="text-lg font-bold text-[#00334F]">Dashboard</h3>
         ...
         <div className="grid grid-cols-2 gap-4">
           {[
             ...
             >
               ...
               <div className="text-xs font-bold text-[#00334F]">{item.label}</div>
             </div>
           ))}
         </div>
      </div>
