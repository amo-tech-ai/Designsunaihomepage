...
import { ScreenScopeContent, ScreenBudgetContent, ScreenBlueprintContent, ScreenDashboardContent, BrowserFrame } from './HowItWorksScreensV7';
      ...
      <div ref={containerRef} className="container mx-auto px-6 lg:px-12 relative min-h-[300vh] flex flex-col lg:flex-row gap-12 lg:gap-24">
        ...
        <div className="lg:w-1/3 lg:h-screen lg:sticky lg:top-0 flex flex-col justify-center py-24">
          <div className="mb-12">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 leading-tight mb-4 tracking-tight">
              ...
              >
                 <div className="flex items-baseline gap-4 mb-2">
                   <span className={`text-4xl font-bold transition-colors duration-500 ${
                     activeStepIndex === i ? "text-slate-900" : "text-slate-300"
                   }`}>
                     {i + 1}.
                   </span>
